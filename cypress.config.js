...
module.exports = defineConfig({
  e2e: {
    ...
    setupNodeEvents(on, config) {
      ...
      // If you want to see 1 message for 1 full run use 'after:spec' function
      ...
      // If you want to see 1 message for 1 spec use 'after:spec' function
      // Uncomment these lines for see results, and comment 'after:run' function
